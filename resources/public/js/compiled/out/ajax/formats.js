...
return cljs.core.some.call(null,(function (p1__2205_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__2205_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__2206){
var map__2207 = p__2206;
var map__2207__$1 = cljs.core.__destructure_map.call(null,map__2207);
var request = map__2207__$1;
var response_format = cljs.core.get.call(null,map__2207__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__2209){
var map__2210 = p__2209;
var map__2210__$1 = cljs.core.__destructure_map.call(null,map__2210);
var request = map__2210__$1;
var response_format = cljs.core.get.call(null,map__2210__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,(function (p1__2208_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__2208_SHARP_);
}),formats);
});
/**
